...
func (r *mutationResolver) FollowUser(ctx context.Context, userID uuid.UUID) (*db.Connection, error) {
	return r.Service.FollowUser(ctx, userID)
}

// UnfollowUser is the resolver for the unfollowUser field.
func (r *mutationResolver) UnfollowUser(ctx context.Context, userID uuid.UUID) (*db.Connection, error) {
	return r.Service.UnfollowUser(ctx, userID)
}

// AcceptUser is the resolver for the acceptUser field.
func (r *mutationResolver) AcceptUser(ctx context.Context, userID uuid.UUID) (*db.Connection, error) {
	return r.Service.AcceptUser(ctx, userID)
}

// RejectUser is the resolver for the rejectUser field.
func (r *mutationResolver) RejectUser(ctx context.Context, userID uuid.UUID) (*db.Connection, error) {
