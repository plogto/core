...
func (r *postResolver) Parent(ctx context.Context, obj *db.Post) (*db.Post, error) {
	postID := obj.ParentID.UUID.String()
...
func (r *postResolver) Content(ctx context.Context, obj *db.Post) (*string, error) {
	postID := obj.ID.String()
	return r.Service.GetPostContentByPostID(ctx, &postID)
}
...
func (r *postResolver) Attachment(ctx context.Context, obj *db.Post) ([]*db.File, error) {
	return r.Service.GetPostAttachmentsByPostID(ctx, obj.ID.String())
}
...
func (r *postResolver) Replies(ctx context.Context, obj *db.Post) (*model.Posts, error) {
	return r.Service.GetPostsByParentID(ctx, obj.ID.String())
}
...
func (r *postResolver) IsSaved(ctx context.Context, obj *db.Post) (*model.SavedPost, error) {
	return r.Service.IsPostSaved(ctx, obj.ID.String())
}
