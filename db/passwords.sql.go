...
func (q *Queries) CreatePassword(ctx context.Context, arg CreatePasswordParams) (*Password, error) {
	row := q.db.QueryRowContext(ctx, createPassword, arg.UserID, arg.Password)
	var i Password
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetPasswordByUserID(ctx context.Context, userID uuid.UUID) (*Password, error) {
	row := q.db.QueryRowContext(ctx, getPasswordByUserID, userID)
	var i Password
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) UpdatePassword(ctx context.Context, arg UpdatePasswordParams) (*Password, error) {
	row := q.db.QueryRowContext(ctx, updatePassword, arg.Password, arg.UserID)
	var i Password
	err := row.Scan(
		&i.ID,
		&i.UserID,
