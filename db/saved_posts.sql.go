...
func (q *Queries) CountSavedPostsByUserIDAndPageInfo(ctx context.Context, arg CountSavedPostsByUserIDAndPageInfoParams) (int64, error) {
	row := q.db.QueryRow(ctx, countSavedPostsByUserIDAndPageInfo, arg.UserID, arg.CreatedAt)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CreateSavedPost(ctx context.Context, arg CreateSavedPostParams) (*SavedPost, error) {
	row := q.db.QueryRow(ctx, createSavedPost, arg.UserID, arg.PostID)
	var i SavedPost
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) DeleteSavedPostByID(ctx context.Context, arg DeleteSavedPostByIDParams) (*SavedPost, error) {
	row := q.db.QueryRow(ctx, deleteSavedPostByID, arg.DeletedAt, arg.ID)
	var i SavedPost
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetSavedPostByID(ctx context.Context, id pgtype.UUID) (*SavedPost, error) {
	row := q.db.QueryRow(ctx, getSavedPostByID, id)
	var i SavedPost
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetSavedPostByUserIDAndPostID(ctx context.Context, arg GetSavedPostByUserIDAndPostIDParams) (*SavedPost, error) {
	row := q.db.QueryRow(ctx, getSavedPostByUserIDAndPostID, arg.UserID, arg.PostID)
	var i SavedPost
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetSavedPostsByUserIDAndPageInfo(ctx context.Context, arg GetSavedPostsByUserIDAndPageInfoParams) ([]*GetSavedPostsByUserIDAndPageInfoRow, error) {
	rows, err := q.db.Query(ctx, getSavedPostsByUserIDAndPageInfo, arg.Limit, arg.UserID, arg.CreatedAt)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
