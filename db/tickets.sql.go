...
func (q *Queries) CountTicketsByUserIDAndPageInfo(ctx context.Context, arg CountTicketsByUserIDAndPageInfoParams) (int64, error) {
	row := q.db.QueryRow(ctx, countTicketsByUserIDAndPageInfo, arg.UpdatedAt, arg.UserID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CreateTicket(ctx context.Context, arg CreateTicketParams) (*Ticket, error) {
	row := q.db.QueryRow(ctx, createTicket, arg.UserID, arg.Subject, arg.Url)
	var i Ticket
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetTicketByURL(ctx context.Context, url string) (*Ticket, error) {
	row := q.db.QueryRow(ctx, getTicketByURL, url)
	var i Ticket
	err := row.Scan(
		&i.ID,
		&i.UserID,
...
func (q *Queries) GetTicketsByUserIDAndPageInfo(ctx context.Context, arg GetTicketsByUserIDAndPageInfoParams) ([]*Ticket, error) {
	rows, err := q.db.Query(ctx, getTicketsByUserIDAndPageInfo, arg.UpdatedAt, arg.Limit, arg.UserID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateTicketUpdatedAt(ctx context.Context, arg UpdateTicketUpdatedAtParams) (*Ticket, error) {
	row := q.db.QueryRow(ctx, updateTicketUpdatedAt, arg.UpdatedAt, arg.ID)
	var i Ticket
	err := row.Scan(
		&i.ID,
		&i.UserID,
